package de.hsworms.inf3032.notification;
...
import de.hsworms.inf3032.activity.NotificationDetailsActivity;
...
public class FirebaseMessagingService extends com.google.firebase.messaging.FirebaseMessagingService {
    ...
    private void sendNotification(String title, String messageBody, String url) {
        ...
        NotificationDbController notificationDbController = new NotificationDbController(FirebaseMessagingService.this);
        ...
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(this, NOTIFICATION_CHANNEL_ID)
                .setSmallIcon(R.drawable.ic_bell_white_48dp)
