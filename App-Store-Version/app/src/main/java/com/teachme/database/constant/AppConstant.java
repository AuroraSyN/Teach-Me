package com.teachme.database.constant;
...
public class AppConstant {
    ...
    public static final String SCRIPTS_JOURNEY_INTERVIEW = "json/Interview/English/Scripts.json";

    // Video files
    public static final String COMPUTER_SCIENCE_VIDEO = "json/Video/English/Computer Science.json";
    public static final String SCRIPTS_VIDEO = "json/Video/English/Scripts.json";


    // Exam files
    public static final String QUESTION1 = "json/Exam/English/Question1.json";
    public static final String QUESTION2 = "json/Exam/English/Question2.json";
    public static final String QUESTION3 = "json/Exam/English/Question3.json";
